...
func server_bios_get_ex() {
	exmpl := `
=========================== dso server bios get examples =========================== 
...
func server_bios_report_ex() {
	exmpl := `
=========================== dso server bios report examples =========================== 
...
func server_bios_set_ex() {
	exmpl := `
=========================== dso server bios set examples =========================== 
